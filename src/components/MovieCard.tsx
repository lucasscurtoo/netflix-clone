    ...
    <div className="group bg-zinc-900 col-span relative h-[12vw]">
      ...
      >
        ...
        >
          ...
          lg:w-10 lg:h-10 rounded-full flex justify-center 
          items-center hover:bg-neutral-300"
            ...
            <div
              ...
              className="cursor-pointer ml-auto group/item w-6 h-6 lg:w-10 lh:h-10 border-white border-2 rounded-full
            flex justify-center items-center transition hover:border-neutral"
            >
              <BiChevronDown
